...
class Point(object):
    ...
    def move_to(self, x, y):
        self.move_dist = self.move_dist + Point.get_distance_from(Point(self.x, self.y),
                                                                  Point(x, y))
        self.x = x
        self.y = y
    ...
    def get_distance_from_start(self):
        return Point.get_distance_from(self, Point(self.start_x, self.start_y))

    def get_distance_traveled(self):
        return self.move_dist

    def closer_to(self, p2, p3):
        if Point.get_distance_from(self, p2) < Point.get_distance_from(self, p3):
            return p2
        elif Point.get_distance_from(self, p2) > Point.get_distance_from(self, p3):
            return p3
        else:
            return p2
